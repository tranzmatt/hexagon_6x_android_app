#ifndef _ANDROID_APP_ASYNC_STUB_H
#define _ANDROID_APP_ASYNC_STUB_H
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(android_app_async_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(android_app_async_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(android_app_async_dummy)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(android_app_async_set_clocks)(remote_handle64 _handle, int32 power_level, int32 latency, int32 dcvs_enabled) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (uint32_t*)&power_level, (uint32_t*)&latency, (uint32_t*)&dcvs_enabled);
}
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(android_app_async_get_stats)(remote_handle64 _handle, android_app_stats* s) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 4;
   return _stub_method_2(_handle, _mid, (uint64_t*)s);
}
static __inline int _stub_method_3(remote_handle64 _handle, fastrpc_async_descriptor_t* asyncDesc , uint32_t _mid, uint32_t _in0[16], char* _in1[1], uint32_t _in1Len[1], char* _rout2[1], uint32_t _rout2Len[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[3] = {0};
   ...
   _TRY_FARF(_nErr, __QAIC_REMOTE(remote_handle64_invoke_async)(_handle , asyncDesc, REMOTE_SCALARS_MAKEX(0, _mid, 2, 1, 0, 0), _pra));
   _CATCH_FARF(_nErr) {
      _QAIC_FARF(RUNTIME_ERROR, "ERROR 0x%x: handle=0x%"PRIx64", scalar=0x%x, method ID=%d: %s failed\n", _nErr , _handle, REMOTE_SCALARS_MAKEX(0, _mid, 2, 1, 0, 0), _mid, __func__);
   }
   return _nErr;
}
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(android_app_async_run)(remote_handle64 _handle, fastrpc_async_descriptor_t*  asyncDesc, const android_app_configs* c, const uint8* in_ptr, int in_ptrLen, uint8* out_ptr, int out_ptrLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 5;
   return _stub_method_3(_handle, asyncDesc, _mid, (uint32_t*)c, (char**)&in_ptr, (uint32_t*)&in_ptrLen, (char**)&out_ptr, (uint32_t*)&out_ptrLen);
}
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(android_app_async_terminate)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 6;
   return _stub_method(_handle, _mid);
}
#ifdef __cplusplus
...
#endif
#endif //_ANDROID_APP_ASYNC_STUB_H
