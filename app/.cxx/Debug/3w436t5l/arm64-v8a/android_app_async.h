#ifndef _ANDROID_APP_ASYNC_H
#define _ANDROID_APP_ASYNC_H
#include <AEEStdDef.h>
#include <remote.h>
#include <string.h>
#include <stdlib.h>
...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(android_app_async_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(android_app_async_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(android_app_async_dummy)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(android_app_async_set_clocks)(remote_handle64 _h, int32 power_level, int32 latency, int32 dcvs_enabled) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(android_app_async_get_stats)(remote_handle64 _h, android_app_stats* s) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(android_app_async_run)(remote_handle64 _h, fastrpc_async_descriptor_t* asyncDesc, const android_app_configs* c, const uint8* in_ptr, int in_ptrLen, uint8* out_ptr, int out_ptrLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(android_app_async_terminate)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
#ifndef android_app_async_URI
#define android_app_async_URI "file:///libandroid_app_async_skel.so?android_app_async_skel_handle_invoke&_modver=1.0"
#endif /*android_app_async_URI*/
#ifdef __cplusplus
}
#endif
#endif //_ANDROID_APP_ASYNC_H
