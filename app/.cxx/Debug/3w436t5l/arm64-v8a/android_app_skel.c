#ifndef _ANDROID_APP_SKEL_H
#define _ANDROID_APP_SKEL_H
...
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t android_app_skel_handle_invoke_qaic_version = 10048;
_ATTRIBUTE_VISIBILITY char android_app_skel_handle_invoke_uri[73+1]="file:///libandroid_app_skel.so?android_app_skel_handle_invoke&_modver=1.0";
...
static __inline int _skel_method_1(int (*_pfn)(remote_handle64, android_app_stats*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   uint64_t _rout0[8] = {0};
...
static __inline int _skel_method_2(int (*_pfn)(remote_handle64, const android_app_configs*, const uint8*, int, uint8*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   uint32_t _in0[16] = {0};
   char* _in1[1] = {0};
   ...
   _TRY(_nErr, _pfn(_h, (const android_app_configs*)_in0, (const uint8*)*_in1, (int)*_in1Len, (uint8*)*_rout2, (int)*_rout2Len));
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(android_app_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc)){
      case 0:
      return _skel_method_5(__QAIC_IMPL(android_app_open), _sc, _pra);
      case 1:
      return _skel_method_4(__QAIC_IMPL(android_app_close), _sc, _pra);
      case 2:
      return _skel_method_3(__QAIC_IMPL(android_app_set_clocks), _h, _sc, _pra);
      case 3:
      return _skel_method_2(__QAIC_IMPL(android_app_run), _h, _sc, _pra);
      case 4:
      return _skel_method_1(__QAIC_IMPL(android_app_get_stats), _h, _sc, _pra);
      case 5:
      return _skel_method(__QAIC_IMPL(android_app_terminate), _h, _sc, _pra);
      case 6:
      return _skel_method(__QAIC_IMPL(android_app_dummy), _h, _sc, _pra);
   }
